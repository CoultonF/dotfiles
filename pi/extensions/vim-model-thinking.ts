...
const ROLES: readonly Role[] = [
   ...
   { label: "commit", provider: "openai-codex", model: "gpt-5.3-codex-spark", thinking: "xhigh" as ThinkingLevel },
   { label: "thinking", provider: "openai-codex", model: "gpt-5.5", thinking: "xhigh" as ThinkingLevel },
];
