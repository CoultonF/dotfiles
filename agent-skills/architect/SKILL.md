...
Use at least two independent runners. Prefer different model families when the platform exposes model selection; otherwise use fresh subagents on the current model.
